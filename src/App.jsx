    ...
    <div className="w-screen h-screen bg-[#424242] flex justify-center items-center">
      <Router>
        <div className="h-[90%] w-1/3  bg-[#212121] rounded-md">
          <div className="w-full h-16 rounded-b-xl bg-yellow-200">
          ...
          <div className="shadow-xl w-[90%] h-64 mx-auto mt-4 rounded-md justify-center items-center overflow-auto">
            <ShowCard />
          </div>
